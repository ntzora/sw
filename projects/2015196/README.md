...
* Δέσμευση περιοχής (position#026) και προσθήκη κώδικα ώστε  να ενεργοποιηθεί η δυνατότητα άντλησης δυναμικών στατιστικών δεδομένων.
* Δημιουργία brunch gh-pages https://github.com/ntzora/sw/tree/gh-pages
